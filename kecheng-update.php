				...
				<form id="form1" action="kecheng-save.php" method="post" class="sui-form form-horizontal sui-validate">
					<div class="control-group">
						...
						<div class="controls">
							...
							<input type="text" value="<?php echo $row['课程名'] ?>" id="kcName" name="kcName" class="input-large input-fat" placeholder="请输入课程名称" data-rules="required|minlength=1|maxlength=10">
						</div>
					</div>
					<div class="control-group">
